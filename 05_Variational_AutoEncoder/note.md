...
- [pdf_1](https://drive.google.com/file/d/1qPN2Uqg2YC8yI2NmBeqvPtcoNx-bJgBU/view?usp=sharing)
    ...
    - Applications
        - PCA vs AutoEncoder
    - Architecture of VAE with breif explanation
    - Prerequsite:
        - Join & Marginal Probability, dependent and independent event **[link](https://github.com/yasin-arafat-05/jupyterNotebook/blob/main/MathForML/probability/note.md)**
        - Conditional Probability
        - Conditional Expectation
        - KL Divergence
        - Bayes Theorm 
        - Therom of total probability
...
- [pdf_2](https://drive.google.com/file/d/1OYj3BG-4phOy2TU0q_mGwsWEuAapFAqT/view?usp=sharing)
    ...
    - Join and Merginal probability with graph
    - Conditional probability with graph 
    - Problem with Posterior Porbability introduction to Variational Inference
    - ELBO Loss
